...
import {DoubleSide, Group, Mesh, MeshStandardMaterial, Quaternion, Vector3, Object3D, Euler, MathUtils, TextureLoader} from "three";
                ...
                const applyMat = (mat: MeshStandardMaterial) => {
                    ...
                    switch (true) {
                        case matName.includes('wall'):
                            ...
                            if (wallTextureBaseColor) {
                                // console.log('[DBG] CIP3D_ModelHandler.tsx/applyMat | Wall Texture Found and Applied');

                                newMat.map = wallTextureBaseColor;
                                break;
                            }
                            // console.log('[DBG] CIP3D_ModelHandler.tsx/applyMat | Wall Texture Not Found, Applied Wall color : ' + defaultWallColor)

                            newMat.color.set(defaultWallColor);
                            break;
                        case matName.includes('inside'):

                            if (insideTextureBaseColor) {
                                // console.log('[DBG] CIP3D_ModelHandler.tsx/applyMat | Inside Texture Found and Applied');

                                newMat.map = insideTextureBaseColor;
                                break;
                            }
                            // console.log('[DBG] CIP3D_ModelHandler.tsx/applyMat | Inside Texture Not Found, Applied Wall color : ' + defaultInsideColor)
